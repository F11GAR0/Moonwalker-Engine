...
public:
	...
	/// \param[in] messageHandlerList A list of registered plugins
	void Update(  SOCKET s, PlayerID playerId, int MTUSize, RakNetTimeNS time, DataStructures::List<PluginInterface*> &messageHandlerList, RakPeer *peer );
...
private:
	...
	void SendBitStream( SOCKET s, PlayerID playerId, RakNet::BitStream *bitStream, RakPeer *peer );
